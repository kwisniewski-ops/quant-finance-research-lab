...
(function () {
  ...
  function render(data) {
    ...
    Plotly.newPlot("chart-dd", [{ x: charts.dates, y: charts.drawdown.map(function (x) { return 100 * x; }), mode: "lines", fill: "tozeroy", line: { width: 1, color: "#8c3a34" }, fillcolor: "rgba(140,58,52,0.12)" }], QL.layout({ title: { text: "DRAWDOWN FROM PEAK (%)", font: { size: 11 }, x: 0 }, xaxis: { title: { text: "date" } }, yaxis: { title: { text: "drawdown (%)" } }, showlegend: false }), QL.plotConfig);
